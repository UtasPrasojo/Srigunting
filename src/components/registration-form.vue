<template>
  <div class="flex min-h-screen">
    ...
    <div class="w-1/2 flex justify-center items-center bg-white">
      <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 class="text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Registrasi</h2>
  ...
  <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Masuk</a>
</div>
